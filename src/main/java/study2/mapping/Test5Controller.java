...
//@WebServlet("/mapping/test5.do") 디렉토리 패턴
@WebServlet("*.do") // 확장자패턴
public class Test5Controller extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String viewPage = "/WEB-INF/study2/mapping"; //command 객체를 사용해아하니까 이렇게 써야한다.
		//	String viewPage = "/WEB-INF/study2/mapping" + com + ".jsp"; //객체를 만들지 않고 jsp만 부르는 방식.
		...
		if(com.equals("/test5")) {
			...
			Test5_5Service t5_5Service = new Test5_5Service(); //하나의 객체 안에 메소드가 있는 게 아니라, 각각 객체를 만들었다. -> command 객체들..
