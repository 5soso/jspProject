...
public class FileUpload2OkCommand implements StudyInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 업로드된 파일의 정보를 추출해보자...
		String originalFileName  = multipartRequest.getOriginalFileName("fName1"); //파일 업로드할 때 파일명
		String filesystemName = multipartRequest.getFilesystemName("fName1"); //서버에 저장된 파일명
