...
public class ScheduleCommand implements ScheduleInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println("d : " + toYear + toMonth + toDay);
		...
		// 다음월을 클릭시 12월(11)은 13월(12)가 넘어오기에, 년도를 +1 더해주고, 월은 1월(0)로 셋팅한다.
		if(mm < 0) {
			yy--;
			mm = 11;
		}
		...
		// 앞에서 셋팅한 해당 '년/월/1'의 요일값을 숫자로 가져온다.(일:1, 월:2, 화:3, 수:4, 목:5, 금:6, 토:7) : 시작테이블의 1일이 들어갈 첫 열을 찾아주기위함
