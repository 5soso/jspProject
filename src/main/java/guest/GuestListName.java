...
@WebServlet("/GuestListName")
public class GuestListName extends HttpServlet{
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//ArrayList<GuestVO> vos = dao.getGuestListName(name);
	...
	// 1.현재 페이지번호를 구한다.
			...
			int totRecCnt = dao.getTotRecCntName(name);
			...
			ArrayList<GuestVO> vos = dao.getGuestListName(startIndexNo, pageSize, name);
			request.setAttribute("vos", vos);
