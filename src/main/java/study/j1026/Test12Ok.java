...
public class Test12Ok extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(name.equals("") || age < 20) {
			...
			//request저장소에 전송하려고 하는 자료들을 모두 담아준다. : request("변수명", 전송값) -전송값을 직접 써도 되고 전송값변수를 써도 된다. 단, 변수명과 전송값의 변수 혼동하면 안 됨.
			...
			String viewPage = "/study/1026/test12Res.jsp"; //앞에 contextPath 안 써도 되는 이유 : RequestDispatcher 클래스 자체가. webapp에 있는 경로만 봄.제일 첫번째 /는  webapp을 나타냄.
