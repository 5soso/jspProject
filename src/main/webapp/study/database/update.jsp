...
<form name="myform" method="post" action="${ctp}/database/updateOk">
  ...
  <table class="table table-bordered">
    <tr>
      ...
      <td class="text-left">${sMid}</td> <!-- 폼태그(input select등)에 없기 때문에 아이디가 안 넘어간다.-->
    </tr>
    <tr>
      <th>비밀번호</th>
      <td><input type="text" name="pwd" id="pwd" value="" class="form-control" autofocus /></td>
    </tr>
    <tr>
      <th>성명</th>
  ...
  <input type="hidden" name="mid" value="${sMid}" /> <!-- 43번라인을 썼다라면,.. 이렇게 넘기면 안 됨. 네임이 같으면 배열로 넘어가기 때문에 -->
 </form>
</div>
<p><br/></p>
</body>
