...
<div class="container">
  ...
  <form name="myform" method="post" action="test1Ok.jsp">
  	...
  	<div>
  		<input type="submit" value="전송(submit)" class="form-control btn btn-success mb-3" />
  		<input type="button" value="전송(button)" onclick="location.href='test10k.jsp?name=홍길동&age=25';" class="form-control btn btn-primary" />
  	</div>
  </form>
</div>
<p><br/></p>
