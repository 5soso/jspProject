...
<head>
  ...
  <script>
    ...
    if('<%=name%>' != '' && '<%=name%>' != 'null') {
    	...
    	/* location.href='test11.jsp?flag=no'; 에러 */
    	location.href='<%=request.getContextPath()%>/study/1026/test11.jsp?flag=no'; 
    }
    ...
    function logoutCheck() {
    	...
    	if(ans) {
    		...
    		/* location.href = 'test11.jsp'; 에러 */
    		location.href = '<%=request.getContextPath()%>/study/1026/test11.jsp';
    	}
    }
  </script>
</head>
