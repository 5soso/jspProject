...
<div class="container">
  ...
  <form name="myform" method="post" action="t3_ApplicationSave.jsp">
  	...
  	<hr/>
	  <div class="row">
	  	<div class="col"><button type="submit" class="form-control btn btn-success">어플리케이션 저장</button></div>
	  	<div class="col"><a href="t3_ApplicationCheck.jsp" class="form-control btn btn-primary">어플리케이션 값 확인</a></div>
	  	<div class="col"><a href="t3_ApplicationNameCheck.jsp" class="form-control btn btn-danger">전체 어플리케이션 이름 확인</a></div>
	  	<div class="col"><a href="t3_ApplicationMidDelete.jsp" class="form-control btn btn-warning">어플리케이션 아이디 삭제</a></div>
	  </div>
  </form>
</div>
<p><br/></p>
