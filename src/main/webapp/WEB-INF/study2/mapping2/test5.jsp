  ...
  <script>
    ...
    function test5Check() {
    	...
    	*/
    	...
    	//form태그에 액션태그를 사용하지 못 할 상황이라면? 자바스크립트에서 action명령으로 이동할 곳의 경로를 지정해준다.
...
<div class="container">
  ...
  <div>
    ...
    <a href="javascript:test5Message()" class="btn w3-black m-3">test5(메세지)</a>
  </div>
  <hr/>
  <div>
    <div>
