  	...
  	function userSearch(idx) {
  		$.ajax({
  			...
  			success : function(res) {
  				...
  				$("#age").val(str[3]);
  				$("#address").val(str[4]);
  				$("#mid").attr("readonly",true); //개별조회 버튼 누르면 아이디 수정불가하도록 함.
  			},
  			error : function() {
  				alert("전송오류");
  			}
  	...
  	<table class="table table-borderd">
  		...
  		<tr>
  			<td colspan="2" class="text-center">
  				...
  				<input type="button" value="전체보기" onclick="location.href='userList.us';" class="btn btn-warning mr-2" />
  			</td>
  		</tr>
  	</table>
